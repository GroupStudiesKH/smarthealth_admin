...
export default {
  ...
  setup() {
    ...
    const createPost = async () => {
      ...
      try {
        errors.value = {};
        const response = await apiService.createPost(postData.value);
        ...
        if (error.response && error.response.data) {
          ...
          showErrorModal("文章創建失敗：" + (error.message || "未知錯誤"));
        }
      } finally {
      ...
      <div class="page-content">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title mb-4">新增文章</h4>
                <form @submit.prevent="createPost" class="w-100 row">
